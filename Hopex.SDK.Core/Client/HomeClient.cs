...
namespace Hopex.SDK.Core.Client
{
    public class HomeClient
    {
        ...
        {
            return HttpRequest.Get<GetIndexStatisticsResponse>("/api/v1/indexStat", null, false);
        }
        ...
        {
            return HttpRequest.Get<ListResultViewModel<GetIndexNotifyResponse>>("/api/v1/index_notify", new Dictionary<string, string>
            {
                {"page", page.ToString() },
